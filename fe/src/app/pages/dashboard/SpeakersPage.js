...
const SpeakerPage = withSwal((props) => {
    ...
    const columns = [
      ...
      columnHelper.accessor(row => `${row.affiliation ? row.affiliation : ''}`, {
        id: 'affiliation',
        header: 'Primary Affiliation'
      }),
      columnHelper.accessor('title'),
      columnHelper.accessor('headshot'),
      columnHelper.accessor(row => `${row.linkedin ? row.linkedin : ''}`, {
        id: 'linkedin',
        header: 'LinkedIn URL'
      }),
      columnHelper.accessor(row => `${row.twitter ? row.twitter : ''}`, {
        id: 'twitter',
        header: 'Twitter URL'
      }),
