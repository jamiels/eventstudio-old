...
const SponsorshipPage = withSwal((props) => {
    ...
    const columns = [
      ...
      columnHelper.accessor(row => `${row.deck ? row.deck : ''}`, {
        id: 'deck',
        header: 'DECK SENT'
      }),
      columnHelper.accessor(row => `${row.amount ? row.amount : ''}`, {
        id: 'amount',
                ...
                <div id="kt_app_toolbar" class="app-toolbar pt-3 pt-lg-3">
                    ...
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                            {/* <!--begin::Breadcrumb--> */}
                            <BreadcrumbCmp title={'Sponsorships'} />
                            {/* <!--end::Breadcrumb--> */}
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <i class="ki-outline ki-plus-square fs-3"></i>New Sponsorhip</a>
                        </div>
                        {/* <!--end::Actions--> */}
                    </div>
                    {/* <!--end::Toolbar wrapper--> */}
